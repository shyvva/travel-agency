...
describe('Component OrderOption', () => {
  ...
  it('should heading have props contents', () => {
...
describe('Component HappyHourAd with mocked descripion props', () => {
  checkDescriptionAtTime('12:00:00', mockProps.description);
  checkDescriptionAtTime('12:59:59', mockProps.description);
  checkDescriptionAtTime('12:33:33', mockProps.description);
});

describe('Component HappyHourAd with mocked Date and delay when test start before 12PM, but content will be check after 12PM', () => {
  checkDescriptionAfterTime('11:57:58', 2, '120');
  checkDescriptionAfterTime('11:59:58', 1, '1');
  checkDescriptionAfterTime('13:00:00', 60 * 60, 22 * 60 * 60 + '');
});
